...
namespace linq_slideviews
{
    public class ParsingTask
    {
        ...
        public static IEnumerable<VisitRecord> ParseVisitRecords(IEnumerable
            <string> lines, IDictionary<int, SlideRecord> slides)
        {
            ...
            foreach (var line in lines.Skip(1))
            {
                ...
                {
                    list.Add(new VisitRecord(userId, slideId, dateTime,
